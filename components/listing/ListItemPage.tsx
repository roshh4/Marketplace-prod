...
import { aiRefine } from '@/lib/utils'
...
const ListItemPage: React.FC<ListItemPageProps> = ({ onDone }) => {
            ...
            <GlassCard>
              ...
              <div className="mt-3 grid grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  <select value={condition} onChange={(e) => setCondition(e.target.value as any)} className="w-full mt-2 p-2 bg-transparent border rounded-md">
                    <option>New</option>
